...
//	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(method.equals("update"))
		{
			...
			form.setFruitName(info.get(2));
			form.setFruitPrice(Double.parseDouble(info.get(3)));
			form.setFruitQuantity(Integer.parseInt(info.get(4)));
			form.setFruitPicture(info.get(5));
